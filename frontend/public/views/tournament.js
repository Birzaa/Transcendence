...
export function renderTournament() {
  ...
  `;
    ...
    const updateHighlight = (playerNum) => {
        document.querySelectorAll(`input[name="color${playerNum}"]`).forEach(r => {
    ...
    [1, 2, 3, 4].forEach(i => {
        document.querySelectorAll(`input[name="color${i}"]`).forEach(input => {
