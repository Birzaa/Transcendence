declare const Chart: typeof import('chart.js/auto')['Chart'];
...
export async function renderPerformances(): Promise<void> {
  ...
  app.innerHTML = `
    <div class="mt-[125px] min-h-screen bg-[url('/images/background.png')] bg-cover bg-center bg-no-repeat bg-fixed p-4">
  ...
  new Chart(document.getElementById('eloChart') as HTMLCanvasElement, {
    type: 'line',
    data: {
